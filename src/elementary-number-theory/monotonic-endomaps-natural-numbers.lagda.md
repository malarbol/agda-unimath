...
### Strictly increasing endomaps of natural numbers grow infinitely
...
module _
  ...
  limit-∞-is-strictly-increasing-endomap-ℕ zero-ℕ =
    ( zero-ℕ , λ p K → leq-zero-ℕ (f p))
  limit-∞-is-strictly-increasing-endomap-ℕ (succ-ℕ M) =
    map-Σ
